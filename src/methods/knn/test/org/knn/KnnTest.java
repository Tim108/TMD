package methods.knn.test.org.knn;

import methods.knn.Feature;
import methods.knn.FeatureSpace;
import methods.knn.Instance;
 ...
 * <p/>
 * To test the knn classification algorithm implementation.
 */
public class KnnTest {
    ...
    public static void main(final String[] args) {
        ...
        // Output the instances category
        System.out.println("Knn computed the instance to be classified to " + instance.category);
    }
